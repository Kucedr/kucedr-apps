...
export const TreeProvider = ({
	...
	const expandedIds = useMemo(
		() => (expansionIsControlled ? new Set(controlledExpandedIds) : internalExpandedIds),
	...
	const handleSelection = useCallback(
		...
		[selectable, multiSelect, currentSelectedIds, selectionIsControlled, onSelectionChange]
	);
